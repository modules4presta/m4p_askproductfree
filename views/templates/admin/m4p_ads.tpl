<div class="panel">
   <b>
       {l s='Please check the PRO version of the Ask about product module.' mod='m4p_askproductfree'}

    <a href="https://modules4presta.io/index.php?action=redirectToModule&fc=module&module=mfp_license_manager&controller=ajax&modulename=m4p_askproductpro" target="_blank">{l s='Show more'}</a>
   </b>
</div>
...
<div class="panel">
    <div class="panel-heading" style="background:#2d2d2d;color:#fff;">
        ...
        <h2><a href="https://modules4presta.io" target="_blank"  style="color:#fff;">Modules4Presta.io</a> {l s='Poleca' mod='m4p_askproductfree'}</h2>
    </div>
    <div class="row">
